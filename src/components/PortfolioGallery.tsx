          ...
          <div
            ...
            <div className="relative overflow-hidden">
              ...
              <div className="absolute inset-0 bg-ink/0 group-hover:bg-ink/20 transition-colors duration-300 flex items-center justify-center">
                <span className="opacity-0 group-hover:opacity-100 transition-opacity duration-300 text-white border border-white/40 px-4 py-2 text-xs tracking-widest uppercase">
                  View
                </span>
              </div>
            </div>
