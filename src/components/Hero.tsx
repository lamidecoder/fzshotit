...
export default function Hero() {
  ...
  return (
    <section className="relative min-h-screen overflow-hidden flex flex-col justify-end pb-24">
      ...
      {/* Overlay — light on top, dark at bottom where text sits */}
      <div className="absolute inset-0 bg-gradient-to-b from-transparent via-transparent to-ink/95" />
      <div className="absolute inset-0 bg-ink/20" />

      {/* Text sits at bottom so photo is fully visible above */}
      <div className="container-shell relative z-10">
        <motion.p
          className="mb-3 text-xs tracking-[0.25em] uppercase text-white/50 font-medium"
        ...
        <motion.h1
          ...
          Rooted in <span className="text-henna">Culture</span>,{" "}
      ...
      <motion.div
        ...
        <span className="text-white/30" style={{ writingMode: "vertical-rl", fontSize: "0.6rem", letterSpacing: "0.3em", textTransform: "uppercase" }}>Scroll</span>
