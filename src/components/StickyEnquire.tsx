...
export default function StickyEnquire() {
  ...
  return (
    <div className={`fixed bottom-6 left-1/2 -translate-x-1/2 z-[100] md:hidden transition-all duration-500 ${
      visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4 pointer-events-none"
    }`}>
      <Link
        href="/contact"
        className="flex items-center gap-2 bg-henna text-bone px-7 py-3.5 font-display font-bold text-sm tracking-wide shadow-2xl">
