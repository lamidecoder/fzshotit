...
const CATS = [
  ...
  { src: "/photos/henna_blue.jpg", label: "Henna", href: "/portfolio/henna", span: "" },
...
const ALL_WORK = [
  ...
  { src: "/photos/henna_real1.jpg", label: "Henna" },
];
      ...
      <section className="container-shell pt-36 md:pt-44 pb-12">
        <Reveal>
          ...
          <h1 className="font-display font-extrabold leading-[0.96]"
            style={{ fontSize: "clamp(2.4rem, 6vw, 4.4rem)" }}>A few favourite days.</h1>
        </Reveal>
      </section>
