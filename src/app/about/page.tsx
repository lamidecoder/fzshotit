    ...
    <>
      <section className="container-shell pt-36 md:pt-44 pb-16">
        <Reveal>
          ...
          <h1
            className="font-display font-extrabold leading-[0.96] max-w-3xl"
      ...
      <section className="container-shell pb-20">
        <div className="grid md:grid-cols-12 gap-8 items-start">
          <Reveal className="md:col-span-5 md:sticky md:top-32">
            <ImageFrame
              src="/photos/IMG_7475.jpg"
              alt="Fauziyah, FZSHOTIT"
              ratio="aspect-[4/5]"
              priority
            />
          </Reveal>
      ...
      <section className="container-shell pb-28">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
          <Reveal><ImageFrame src="/photos/DSC05674.jpg" alt="Work 1" ratio="aspect-[3/4]" /></Reveal>
          <Reveal delay={0.08}><ImageFrame src="/photos/DSC08906.jpg" alt="Work 2" ratio="aspect-[3/4]" /></Reveal>
          <Reveal delay={0.16}><ImageFrame src="/photos/IMG_7449.jpg" alt="Work 3" ratio="aspect-[3/4]" /></Reveal>
